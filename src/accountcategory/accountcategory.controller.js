const AccountcategoryModel = require('./accountcategory.model');
  ...
  exports.insert = (req, res) => {
        ...
        req.body.createAt=funcs.getTime()
            AccountcategoryModel.createAccountcategory(req.body)
                  .then((result) => {
  ...
  exports.list = (req, res ) => {
      ...
      AccountcategoryModel.list(limit, page,req.query)
          .then((result) => {
  ...
  exports.listAll = (req, res ) => {
     ...
     */
    AccountcategoryModel.listAll(req.query)
        .then((result) => {
            res.status(200).send(result);
        }).catch((err)=>{
            res.status(400).json( {err:err} );
...
exports.listSuggestions = (req, res ) => {
     ...
     */
    AccountcategoryModel.listSuggestions(req.query)
        .then((result) => {
            res.status(200).send(result);
        }).catch((err)=>{
            res.status(400).json( {err:err} );
  ...
  exports.getById = (req, res) => {
     ...
     */
    AccountcategoryModel.findById(req.params.accountcategoryId,filter)
          .then((result) => {
              res.status(200).send(result);
          }).catch((err)=>{
              res.status(400).json( {err:err} );
  ...
  exports.patchById = (req, res) => {
     ...
     */
      AccountcategoryModel.patchAccountcategory(req.params.accountcategoryId, req.body,filter)
          .then((result) => {
              res.status(204).send({});
          }).catch((err)=>{
              res.status(400).json( {err:err} );
  ...
  exports.removeById = (req, res) => {
     ...
     */
    AccountcategoryModel.removeById(req.params.accountcategoryId,filter)
          .then((result)=>{
              res.status(204).send({});
          }).catch((err)=>{
              res.status(400).json( {err:err} );
